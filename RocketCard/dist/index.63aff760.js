...
function handleClick(e) {
    ...
    if (e.target.id === "bg") bgCard.style.backgroundColor = randomRGB();
    else if (e.target.id === "download") (0, _htmlToImage.toJpeg)(document.querySelector(".card"), {
        quality: 0.95
...
},{"./util":"eIddd","./dataurl":"a60cP","./embed-resources":"7yOGJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lmKb7","adjPd"], "adjPd", "parcelRequire4f46")
